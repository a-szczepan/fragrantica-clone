        ...
        <section className="about-section">
          <div className="section-containter">
            ...
            <p>
              ...
              composition's ingredients - divided by fragrance notes. Perfumes
              are also classified by olfactor groups. Therefore allows users to
              expand their knowledge and compare products with each other.
            </p>
          </div>
          <img src={photoA}></img>
        </section>
